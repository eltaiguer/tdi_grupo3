...
void setup() {
  ...
  for (int i = 0; i < jointCollection.length-1; i=i+1){
    ...
    float xPosition1 = jointCollection[i].getChild("X").getFloatContent()*800;
    float yPosition1 = jointCollection[i].getChild("Y").getFloatContent()*800;
    float zPosition1 = jointCollection[i].getChild("Z").getFloatContent()*800;
    float speed = jointCollection[i+1].getChild("Speed").getFloatContent();
    
    float xPosition2 = jointCollection[i+1].getChild("X").getFloatContent()*800;
    float yPosition2 = jointCollection[i+1].getChild("Y").getFloatContent()*800;
    float zPosition2 = jointCollection[i+1].getChild("Z").getFloatContent()*800;
